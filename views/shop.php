          ...
          <div class="featured__item">
            <div
              ...
              <ul class="featured__item__pic__hover">
                <li>
                  <a href="index.php?action=sanpham&&id=<?= $item['id'] ?>"><i class="fa fa-eye"></i></a>
                </li>
            ...
            <div class="featured__item__text">
              <h6><a href="index.php?action=sanpham&&id=<?= $item['id'] ?>"><?php echo $item['name']; ?></a></h6>
          ...
          <div class="latest-product__slider owl-carousel">
            <?php foreach ($productsNew as $item) { ?>
              <div class="latest-prdouct__slider__item">
                <a href="index.php?action=sanpham&&id=<?= $item['id'] ?>" class="latest-product__item">
